...
| TD-18 | TFW-7 RF obs. #1 | Med | `RF_TFW-5` §3.7 | Pipeline type=13 описан как 4 сущности, практика ИС ОВПО показывает 6+1 (+ ORDER_STUDENT_INFO, ORDERS_ADDITIONAL, TRANSCRIPT) | ⬜ Backlog |
